...
- **Testing & Quality:** RSpec, FactoryBot, pytest, Django TestCase, CI/CD pipelines  
- **Other:** Background jobs (Solid Queue), CSV import/export, web scraping, ML (NumPy, Pandas, scikit‑learn), Pundit authorization, Hotwire/Turbo/Stimulus, Tailwind CSS  
